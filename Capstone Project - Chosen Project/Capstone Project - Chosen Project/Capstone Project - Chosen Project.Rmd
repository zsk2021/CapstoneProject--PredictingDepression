...
each arm, I transpose the data frames, so the p-values are in a separate column and the data frame in tidy format:
```{r, warning=FALSE, message=FALSE}
# Group 1 - transpose
...
Next, I will apply SVM on the data set, but first I standardize the features:
```{r}
