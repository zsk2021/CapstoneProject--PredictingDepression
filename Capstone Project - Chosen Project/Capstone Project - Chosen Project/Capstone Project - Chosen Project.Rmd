...
Next, I the data set was edited; some of the measured molecules have been removed from the list
...
```
## *k-NN model
In this section I will work with the standardized dataset, adn I will fit a k-NN model
using this data set:
```{r}
...
model_results_tibble <- tibble(Models = c("SVM Linear", 
                                          ...
                                          "RMF", "KNN"),
                               TrainFit = c(mean_linear_train,
                                            mean_linear_train_st,
                                            classification_accuracy_tr,
                                            '-'),
                               TestFit = c(mean_linear_test,
                                           mean_linear_test_st,
                                           classification_accuracy_test,
                                           classification_accuracy_knn),
                               Validation = c(mean_linear_valid,
                                              mean_linear_valid_st,
                                              classification_accuracy_val,
                                              classification_accuracy_knn_valid)) %>% 
